...
public class Planeta {
    ...
    public void imprimirAtrib(){
        ...
        switch (tipoPlaneta) {
            case 1 -> System.out.println("Tipo de planeta: Gaseoso");
            case 2 -> System.out.println("Tipo de planeta: Terrestre");
            case 3 -> System.out.println("Tipo de planeta: Enano");
